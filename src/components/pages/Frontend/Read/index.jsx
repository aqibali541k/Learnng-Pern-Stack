...
const Read = () => {
    ...
    return (
        <div className='bg-cyan-400 min-h-screen'>
            ...
            <table className='max-w-3xl mx-auto w-full border-2 border-gray-300'>
                <thead>
                    <tr className='border-2 bg-green-700 text-white border-gray-300'>
                        <td className='border-2 font-bold p-2 border-gray-300'>Name</td>
                        <td className='border-2 font-bold p-2 border-gray-300'>Phone</td>
                        <td className='border-2 font-bold p-2 border-gray-300'>Age</td>
                        <td className='border-2 font-bold p-2 border-gray-300'>ProfilePic</td>
                        <td className='border-2 font-bold p-2 border-gray-300'>Actions</td>
                    </tr>
                </thead>
                <tbody className='border-2 bg-blue-700 text-white border-gray-300'>
                    {
                        users.length === 0 ? (
                            <tr>
                                    ...
                                    <tr key={user.Id}>
                                        ...
                                        <td className=' p-2 gap-2 flex border-gray-300'>
                                            ...
                                            <Popconfirm
                                                ...
                                                cancelText="No"
                                            >
                                                <button className='bg-red-600 p-2 cursor-pointer hover:bg-red-700 transition-all duration-300 shadow-lg  text-white rounded-lg'> <FaTrash /> </button>
                                            </Popconfirm>
                                        </td>
                                    </tr>
                                )
